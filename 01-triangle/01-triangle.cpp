...
private:
  ...
  void createInstance() {
    ...
    // Check if the required layers are supported by the Vulkan implementaion.
  ...
  void setupDebugMessenger() {
    ...
    vk::DebugUtilsMessageSeverityFlagsEXT severtyFlags(
  ...
  void createLogicalDevice() {
    ...
    // get the frist index into queueFamilyProperties which supports graphics
